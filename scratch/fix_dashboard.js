...
<head>
    ...
    <title>Tech Turf | Command Center</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <!-- Universal Modern Glass Sidebar -->
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu" id="main-sidebar-nav">
                <div class="menu-item active" data-nav="dashboard.html" onclick="window.location.href='dashboard.html'">
        ...
        <main class="main-content">
            <header class="navbar">
                <div class="nav-left">
                    <button id="mobile-toggle" class="mobile-hamburger" title="Toggle Mobile Navigation"><i
                ...
                <div class="nav-actions">
                    <div class="notification-bell" id="notification-bell">
                        ...
                        <div class="notification-dropdown glass-card notification-dropdown-container"
                            id="notification-dropdown">
                            <div class="notification-header">
                                <span class="notification-title">Notifications</span>
                                <span class="notification-mark-read"
                                    onclick="api.put('/notifications/read-all').then(loadNotifications)">Mark all
                                    read</span>
                            </div>
                    ...
                    <div class="user-profile-nav" data-nav="profile.html">
                        <div class="user-nav-text">
                            <div id="nav-user-name" class="user-nav-name">User Name</div>
                            <div id="nav-user-role" class="user-nav-role">Role</div>
                        </div>
                        <img id="nav-avatar" class="user-avatar" src="" alt="Avatar">
                    </div>
                </div>
            </header>
            ...
            <div class="page-header">
                ...
                <div class="tl-only">
                    <button class="btn-primary" data-nav="projects.html?new=1">
            ...
            <div class="dashboard-grid">
                ...
                <!-- Card: Performance Leaderboard (3D Isometric Chart) -->
                <div class="glass-card dash-card dash-card-wide anim-fade-up">
                    <div class="card-header-flex">
                        <div class="card-title-text">TOP PERFORMERS</div>
                        <i class="fas fa-trophy performer-trophy"></i>
                    </div>
                    <div id="dash-performers-list" style="display:none;"></div>
                    <div class="performers-graph-wrapper">
                        <canvas id="top-performers-chart" class="performers-3d-canvas"></canvas>
                    </div>
                </div>

                <!-- Right Column: Stacked Square Cards (Tasks & Projects) -->
                <div class="dash-stacked-col">
                    <!-- Card: My Tasks (Recent 2) -->
                    <div class="glass-card dash-card dash-card-square anim-fade-up">
                        <div class="card-header-flex">
                            <div class="card-title-text">MY ACTIVE TASKS</div>
                            <i class="fas fa-tasks task-icon-sec"></i>
                        </div>
                        <div id="dash-tasks-list"></div>
                    </div>

                    <!-- Card: Project Progress (Recent 2) -->
                    <div class="glass-card dash-card dash-card-square anim-fade-up">
                        <div class="card-header-flex">
                            <div class="card-title-text">PROJECT PROGRESS</div>
                            <i class="fas fa-chart-pie project-icon-green"></i>
                        </div>
...
fs.writeFileSync('c:/LOKI/Techturf/TT_CRM_Update/project/frontend/public/dashboard.html', cleanDashboardHtml, 'utf8');
fs.writeFileSync('c:/LOKI/Techturf/TT_CRM_Update/project/frontend/dashboard.html', cleanDashboardHtml, 'utf8');
console.log('Cleaned and synced dashboard.html');
