...
// 1. Update CSS
const cssAddition = `
/* Modern Notification Dropdown & Drawer Styles */
...
.notification-dropdown-container {
  ...
  animation: modalSpringIn 0.2s cubic-bezier(0.16, 1, 0.3, 1);
}

body.dark-mode .notification-dropdown,
body.dark-mode .notification-dropdown-container {
  background: #0f172a;
...
['project/frontend/public/css/main.css', 'project/frontend/css/main.css'].forEach(p => {
  ...
  if (!c.includes('/* Modern Notification Dropdown & Drawer Styles */')) {
    fs.writeFileSync(p, c + '\n' + cssAddition, 'utf8');
    console.log('Appended notification CSS to', p);
  }
});

// 2. Update sidebar.js with complete notification controller
const updatedSidebarJs = `function initSidebar() {
...
fs.writeFileSync('project/frontend/public/js/sidebar.js', updatedSidebarJs, 'utf8');
fs.writeFileSync('project/frontend/js/sidebar.js', updatedSidebarJs, 'utf8');
console.log('Updated sidebar.js across public/ and frontend/ with modern notification system.');
